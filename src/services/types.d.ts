export interface Summoner {
    ...
    getSummonerData(summonerName: string, regionId: string): Promise<Participant>
}

export type MatchIdList = Array<string>;

export interface MatchesService {
    getMatchHistory(puuid: string): Promise<MatchIdList>,
    getMatches(matchHistory): Promise<Matches[]>
}
